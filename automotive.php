            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <br>
                        <p class="text-p">
                            Predictive Maintenance, Connected Car Cyber Security, Auto Marketing, and Predictive
                            Collision Avoidance. We’ve got you covered.
                        </p>
                        <br>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md">
                    <div class="px-4 box-content-left">
                        ...
                        <div class="imgW-more">
                            <p class="text-p">When it comes to the automotive industry, they certainly have a thing for
                                sci-fi movies. Considering its tech love, the automotive industry has indulged into
                                predictive analytics for- Predictive Maintenance, Connected Car Cyber Security, Auto
                                Marketing, and Predictive Collision Avoidance. Predictive maintenance just as it sounds,
                                notifies when and under what circumstances is the automobile going to require
                                maintenance. </p>
                        </div>
                    </div>
                </div>

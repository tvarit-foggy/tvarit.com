      ...
      <div class="container">
        ...
        <div class="col-md-4">
            <div class="featureBox">
              ...
              <div class="more">
                    <p class="text-p">
                    We have developed supervised & non- supervised ML algorithms which analysis all structured and non-structured data to predict 
                      ...
                      operational and capital expenses and better streamlining of workflow.
                    </p>
              </div>
          ...
          <div class="col-md-4">
            <div class="featureBox">
              ...
              <div class="more">
                    <p class="text-p">
                    We have developed word-class solution for inventory optimization which not only analysis multi-structured data but also learns from 
          ...
          <div class="col-md-4">
            <div class="featureBox">
              ...
              <div class="more">
                <p class="text-p">
                Our solution enables you to optimize energy management by utilizing highest number of AI algorithms. It generates better energy 
                  ...
                  automatically manage and optimize operations in real time. It can help you in achieving your carbon emission and sustainability goals.
                </p>
              </div>
          ...
          <div class="col-md-4">
            <div class="featureBox">
              ...
              <div class="more">
                    <p class="text-p">
                    Our smart and simple solution enables you to increase the precision, efficiency and speed of your quality control process. It can help 

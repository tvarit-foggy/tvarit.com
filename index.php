...
<body>
    ...
    <div class="section-padding">
        <div class="container">
            ...
            <p>The TVARIT Industrial Artificial Intelligence (TIA) software is a ready-to-use state-of-the-art Smart Factory and Digital Twin Software. Receive in depth insights based on the analysis of machine data, sensor data, manufacturing execution systems data, Laboratory information management systems data and ERP data. Get the relevant information in customized and user-oriented dashboards – whether you are an executive, plant manager, quality manager, shop floor engineer or technologist.  Monitor key parameter indicators (KPI) such as machine availability, quality rate and performance (Overall equipment effectiveness) in real-time and prevent quality deviations and machine breakdowns with the help of predictive analytics. Furthermore, prescriptive dynamic recipes provide you with actionable recommendations for process optimization. Keep track of all the important incidents with notification and alerts. Overall, TIA enables you to optimize OEE, reduce scrap, increase efficiency and improve machine availability. Finally, this leads to reduced costs, increased production output as well as an optimized usage of manpower, machines and material.  </p>
            <p>Some of the most relevant implemented use-cases are:</p>
            <br>

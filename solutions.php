            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <div class="more">
                            <p class="text-p">
                            Our solution division provides end to end digital solutions to clients including problem formulation, business analysis, consulting and solution development. Our solution division turns corporate ideas into digital products with ease. The core of solution division remains IoT, data analytics, sensor data analytics and digital to cloud services.
                            </p>
                        </div>
                        <br>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md">
                    <div class="px-4 box-content-left">
                        <div class="title">
                            <div class="text-big60 fw-900 red">Solutions</div>
                        </div>

                                    ...
                                    <ul class="ul-sub-menu">
                                        <li>
                                            ...
                                            <ul class="ul-deep-menu">
                                                <li>
                                                    <a href="learn#Quality_Prediction" class="sub-Link">Quality
                                                        Prediction</a>
                                                </li>
                                                <li>
                                                    <a href="learn#Predictive_Maintenance" class="sub-Link">Predictive
                                                        Maintenance</a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <a href="learn#Asset_and_Inventory_Management"
                                                        class="sub-Link">Asset and Inventory Management</a>
                                                </li>
                                                <li>
                                                    <a href="learn#Intra-plant_Logistics" class="sub-Link">Intra-plant
                                                        Logistics</a>
                                                </li>
                                            </ul>
                                        </li>
                ...
                <div class="section-padding-both countBg parallax-bg parallax" data-diff="100" id="counter">
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="countBox">
                                    <div class="figure"><span class="figureNum" data-count="0">100</span> <small
                                            class="x"></small></div>
                    ...
                    <div class="container">
                        <div class="white-box-shadow">
                            ...
                            <div class="centerPharseContent text-p">
                                We’re based out of Niedernhausen Germany having the perfect team composition - a German

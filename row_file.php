            ...
            <div class="submenu-div">
                <div class="row">
                    ...
                    <div class="col">
                        <ul class="ul-sub-menu">
                            <li>
                                <a href="ai_software_solution#optimize_oee_for_steel_and_metal_manufacturing_companies" class="sub-Link">Optimize OEE for Steel and Metal Manufacturing companies</a>
                            </li>
                            <li>
                                <a href="ai_software_solution#predictive_maintenance_for_industrial_electric_motors" class="sub-Link">Predictive Maintenance for  Industrial Electric Motors</a>
                            </li>
                            <li>
                                <a href="ai_software_solution#ai_based_production_planning_solution_for_cable_manufacturing_companies" class="sub-Link">AI Based Production Planning Solution for Cable Manufacturing Companies</a>
                            </li>
                            <li>
                                <a href="ai_software_solution#preductive_quality_for_injection_moulding_machines" class="sub-Link">Preductive Quality for Injection Moulding Machines</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col">
                        <ul class="ul-sub-menu">
                                <li>
                                <a href="ai_software_solution#./img/plus_ai.png" class="sub-Link" style="padding-left: 92px;">
                                    <img class="ai_solutions_img" src="./img/plus_ai.png" alt="Achieve More Tvarit AI Solutions" widht="100px" height="120px" />
                                    <div class="ai_solution_tb textBig">
                                    <p class="" style="align-item: center;"> Achieve More Tvarit AI Solutions </p>
                                    </a>
                                    </div>
                            </li>
                        </ul>
    ...
    <li class="nav-item">
            ...
            <div class="submenu-div">
                <div class="row">
                    <div class="col">
                        <div class="menuQuote">
                            <div class="textBig">AI Consultion<span class="red">.</span></div>
                            <p class="text-normal"> ..... </p>
                        </div>
                    </div>
                    <div class="col">
                        <ul class="ul-sub-menu">
                            <li>
                                <a href="ai_consultion#menu1" class="sub-Link">menu1</a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!--ul class="ul-sub-menu">
    <li>
        optimize_oee_for_steel_and_metal_manufacturing_companies
    </li>
    <li>
        
        predictive_maintenance_for_industrial_electric_motors
    </li>
    <li>
        ai_based_production_planning_solution_for_cable_manufacturing_companies
    </li>
    <li>
       preductive_quality_for_injection_moulding_machines
    </li>
</ul-->
seminar_workshops

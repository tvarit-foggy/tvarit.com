...
<head>
    <title>Ai In Die Casting Short Success Story</title>
    <style>
    html,
    body {
        margin: 0;
...
<style type="text/css">
    ...
    .ddr-page-wrapper .ddr-page-wrapper {
        margin: 50x 50x 50x 50x;
        padding: 50x 50x 50x 50x;
        background: #fff !important;
    }

    .ddr-page-wrapper #ddr-24581b8544 .ddr-widget__button>a>div {
        background-color: linear-gradient(to right, #f74785 0%, #ed1b4a 99%) !important;
        box-sizing: content-box;
        word-break: break-all;
        transition: all 0.5s ease 0s;
    }
                            ...
                            <div id="ddr-164f1de5b7" class="ddr-page-widget ddr-page-widget__rich-text ddr-page-widget-0 " data-ddr-page-widget-additional-css-id="afd14b9c35">
                                <div class="ddr-widget">
                                    <div id="ddr-rich-text-4000" class="ddr-widget__rich-text" style="margin: 30px; padding-bottom: 15px; border-style: solid; border-width: 0px;">
                                        <p style="text-align: center;"><strong><span style="font-size: 32px;">25%</span></strong></p>
                                        <p style="text-align: center;"><span style="font-weight: 400;">Reduktion von Ausschuss</span></p>
                                        <p style="text-align: center;"></p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="ddr-bdcf148a50" class="ddr-page-widget ddr-page-widget__rich-text ddr-page-widget-0 " data-ddr-page-widget-additional-css-id="5c5a3e9b18">
                                <div class="ddr-widget">
                                    <div id="ddr-rich-text-4010" class="ddr-widget__rich-text" style="margin: 30px; padding-bottom: 15px;">
                                        <p style="text-align: center;"><span style="font-size: 32px;"><strong>76%</strong></span></p>
                                        <p style="text-align: center;"><span style="font-weight: 400;">Genauigkeit der Vorhersagen</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="ddr-72ca09a235" class="ddr-page-widget ddr-page-widget__rich-text ddr-page-widget-0 ">
                                <div class="ddr-widget">
                                    <div id="ddr-rich-text-4020" class="ddr-widget__rich-text" style="margin: 30px; padding-bottom: 15px;">
                                        <p style="text-align: center;"><span style="font-size: 32px;"><strong>100% </strong></span></p>
                                        <p style="text-align: center;"><span style="font-weight: 400;">Kundenzufriedenheit</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>

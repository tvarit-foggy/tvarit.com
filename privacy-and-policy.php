    ...
    <div class="section-padding-both-2x" id="Philanthropy">
        <div class="container">
            ...
            <p>
                ...
                for
                the management of Tvarit GmbH. The Tvarit GmbH website can be used without providing
                any personal data. However, if a data subject wishes to make use of our company&#39;s special
                services via our website, it may be necessary to process personal data. If the processing of
                personal data is necessary and there is no legal basis for such processing, we generally
                obtain the consent of the person concerned.
            </p>
            <p>
                The processing of personal data, for example the name, address, e-mail address or
                telephone number of a person concerned, always takes place in accordance with the
                General Data Protection Regulation and in accordance with the country-specific data
                protection regulations applicable to Tvarit GmbH. With this data protection declaration, our
                company would like to inform the public about the type, scope and purpose of the personal
                data we collect, use and process. Furthermore, data subjects are informed about their rights
                by means of this data protection declaration.
            </p>
            <p>
                As the controller, Tvarit GmbH has implemented numerous technical and organizational
                measures to ensure the most complete protection possible for personal data processed via
                this website. However, Internet-based data transmissions can generally have security gaps,
                so that absolute protection cannot be guaranteed. For this reason, every person concerned is
                free to transmit personal data to us in alternative ways, for example by telephone.
            </p>
            <h4>1. DEFINITION</h4>
            <p>
            ...
            <ul style="list-style: none">
                <li>
                    ...
                    <p>
                        Personal data is all information that relates to an identified or identifiable natural
                        person (hereinafter &quot;data subject&quot;). A natural person is considered to be identifiable
                        who, directly or indirectly, in particular by means of assignment to an identifier such
                        as a name, an identification number, location data, an online identifier or one or more
                        special features that express the physical, physiological, genetic, psychological,
                        economic, cultural or social identity of this natural person can be identified.
                    </p>
                </li>
                <li>
                    <h4> B) DATA SUBJECT</h4>
                    <p>
                        Affected person is any identified or identifiable natural person whose personal data is
                        processed by the person responsible for processing.
                    </p>
                </li>
                <li>
                    <h4>C) PROCESSING</h4>
                    <p>
                        ...
                        procedures or any such series of processes in connection with personal data such as
                        the collection, recording, organization, sorting, storage, adaptation or modification,
                        reading, querying, use, Disclosure by transmission, dissemination or any other form of
                ...
                <li>
                    ...
                    <p>
                        ...
                        this personal data to evaluate certain personal aspects that relate to a natural person,
                        in particular aspects relating to work performance, economic situation, health,
                        personal To analyze or predict the preferences, interests, reliability, behavior,
                        whereabouts or relocation of this natural person.
                    </p>
                </li>
                <li>
                    <h4>F) PSEUDONYMIZATION</h4>
                    <p>
                        Pseudonymization is the processing of personal data in a way in which the personal
                        data can no longer be assigned to a specific data subject without the use of additional
                        information, provided that this additional information is stored separately and is
                        subject to technical and organizational measures that guarantee that the personal
                ...
                <li>
                    ...
                    <p>
                        The controller or the person responsible for processing is the natural or legal person,
                        public authority, agency or other body that alone or jointly with others decides on the
                        purposes and means of processing personal data. If the purposes and means of this
                        processing are specified by Union law or the law of the member states, the person
                        responsible or the specific criteria for his appointment can be provided for in
                        accordance with Union law or the law of the member states.
                    </p>
                </li>
                <li>
                    <h4>H) PROCESSORS</h4>
                    <p>
                        Processor is a natural or legal person, authority, institution or other body that
                ...
                <li>
                    <h4> I) RECIPIENT</h4>
                    <p>
                        The recipient is a natural or legal person, authority, institution or other body to which
                        personal data is disclosed, regardless of whether it is a third party or not. Authorities
                        that may receive personal data as part of a specific investigation under Union law or
                        the law of the member states are not considered recipients.
                    </p>
                </li>
                <li>
                    <h4>J) THIRD PARTY</h4>
                    <p>
                        ...
                        the data subject, the controller, the processor and the persons who are authorized to
                        process the personal data under the direct responsibility of the controller or the
                        processor.
                    </p>
                </li>
                <li>
                    <h4>K) CONSENT</h4>
                    <p>
                        Consent is any voluntary, informed and unequivocal declaration of intent given by the
                        person concerned for the specific case in the form of a declaration or other

                        unequivocal affirmative act with which the person concerned indicates that they
                        consent to the processing of their personal data is.
            ...
            <p>
                ...
                of a data protection nature is:<br><br>
            ...
            <p>
                ...
                specific internet browser can be recognized and identified via the unique cookie ID.<br>
                By using cookies, Tvarit GmbH can provide the users of this website with more user-friendly
                services that would not be possible without the cookie setting.<br>
                ...
                browser used, not all functions of our website may be fully usable.<br>
            </p>
            ...
            <p>
                ...
                information are stored in the server&#39;s log files. The <br>
                (1) browser types and versions used,<br>
                (2) the operating system used by the accessing system, <br>
                (3) the website from which an accessing system reaches our website (so-called referrer), <br>
                ...
                (7) the internet service provider of the accessing system and <br>
                (8) other similar data and information,<br>
                When using this general data and information, Tvarit GmbH does not draw any conclusions
                about the person concerned. Rather, this information is required to <br>
                (1) correctly deliver the content of our website, <br>
            ...
            <p>
                ...
                data exclusively for internal use,<br>
                ...
                legal obligation to pass on or the passing on is used for criminal prosecution.<br>
                ...
                from the database of the person responsible for processing.<br>
                ...
                to the data subject as contact persons in this context.<br>
            </p>
            <h4>6. SUBSCRIPTION TO OUR NEWSLETTER</h4>
            <p>
                ...
                transmitted to the person responsible for processing when ordering the newsletter.<br>
                ...
                person concerned if <br>
                (1) the person concerned has a valid e-mail address and <br>
                (2) the person concerned registers to receive the newsletter.<br> 
                ...
                or to inform the person responsible for processing of this in another way.<br>
            </p>
            ...
            <p>
                ...
                links in the e-mail were called up by the data subject.<br>
            ...
            <h4>8. CONTACT OPTIONS VIA THE WEBSITE</h4>
            <p>
                Due to legal regulations, the Tvarit GmbH website contains information that enables quick
                electronic contact with our company and direct communication with us, which also includes
                a general address for so-called electronic mail (e-mail address). If a data subject contacts the
                person responsible for processing by email or a contact form, the personal data transmitted
                by the data subject will be automatically saved. Such personal data transmitted on a
                voluntary basis by a data subject to the person responsible for processing are stored for the
                purpose of processing or contacting the data subject.
            </p>
            <h4>9. COMMENT FUNCTION IN THE BLOG ON THE WEBSITE</h4>
            <p>
                ...
                commented on by third parties.<br>
            ...
            <p>
                ...
                a specific blog post that follow his comment.<br>
            ...
            <h4>11. ROUTINE DELETION AND BLOCKING OF PERSONAL DATA</h4>
            <p>
                ...
                person responsible for processing is subject to, was provided.<br>
            ...
            <ul style="list-style: none">
                <li>
                    ...
                    <p>
                        Every person concerned has the right granted by the European directive and
                        regulation giver to request confirmation from the person responsible for processing
                        as to whether personal data concerning them are being processed. If a data subject
                        wishes to make use of this right to confirmation, they can contact an employee of the
                ...
                <li>
                    ...
                    <p>
                        ...
                        European directive and regulation giver to receive free information about the personal
                        data stored about him and a copy of this information from the person responsible for
                        processing at any time. Furthermore, the European directives and regulations grant
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            been disclosed or are still being disclosed, in particular for recipients in third
                        ...
                        <li>
                            ...
                            information about the logic involved and the scope and intended effects of
                            such processing for the data subject</li>
                    </ul>
                    Furthermore, the data subject has the right to information as to whether personal data
                    has been transmitted to a third country or to an international organization. If this is the
                    case, the data subject has the right to receive information about the appropriate
                    guarantees in connection with the transmission.<br>
                    If a data subject wishes to exercise this right to information, he or she can contact an
                    employee of the person responsible for processing at any time.
                    </p>
                </li>
                <li>
                    ...
                    <p>
                        ...
                        incomplete personal data - including by means of a supplementary declaration.<br>
                ...
                <li>
                    ...
                    <p>
                        ...
                        reasons applies and insofar as the processing is not necessary:<br>
                    <ul>
                        <li>
                        ...
                        <li>
                            ...
                            accordance with Article 6 <br>(1) (a) GDPR or Article 9 <br>(2) (a) GDPR, and there is no
                        ...
                        <li>
                            ...
                            GDPR to the Processing a.
                        </li>
                        <li>
                            The personal data was processed unlawfully.
                        </li>
                        <li>
                            The deletion of personal data is necessary to fulfill a legal obligation under
                    ...
                    stored at Tvarit GmbH deleted, they can contact an employee of the person
                    responsible for processing at any time. The Tvarit GmbH employee will arrange for
                    the deletion request to be complied with immediately.<br>
                    If the personal data have been made public by Tvarit GmbH and our company, as the
                    controller, is obliged to delete the personal data in accordance with Art. 17 Paragraph
                    1 GDPR, Tvarit GmbH will take appropriate measures, taking into account the available
                    technology and the implementation costs of a technical nature, in order to inform
                    other data processors who process the published personal data that the data subject
                    has requested the deletion of all links to this personal data or of copies or replications
                    of this personal data from these other data processors has requested, as far as the
                    processing is not necessary. The employee of Tvarit GmbH will arrange the necessary
                ...
                the processing if one of the following conditions is met:<br>
            <ul>
                <li>
                    The correctness of the personal data is contested by the data subject for a
                    period of time that enables the controller to check the correctness of the
                    personal data.
                </li>
                <li>
                    The processing is unlawful, the person concerned refuses to delete the
                ...
                <li>
                    ...
                    processing, but the person concerned needs them to assert, exercise or
                    defend legal claims.
                </li>
                <li>
                    The person concerned has an objection to the processing in accordance
                    with. Art. 21 para. 1 GDPR and it has not yet been determined whether the
                    legitimate reasons of the controller outweigh those of the person concerned.
                </li>
            </ul>
            If one of the above conditions is met and a data subject would like to request the
            restriction of personal data stored at Tvarit GmbH, they can contact an employee of
            the person responsible for processing at any time. The employee of Tvarit GmbH will
            ...
            does not affect the rights and freedoms of other persons.<br>
            ...
            assert, exercise or defend of legal claims.<br>
            ...
            processing is necessary to fulfill a task in the public interest.<br>
            ...
            specifications are used.
                ...
                <p>
                Every person affected by the processing of personal data has the right granted by the
            European <b>legislator of directives and regulations not to be subjected to a decision
                based solely on automated </b>processing - including profiling - which has legal effects
            on them or which significantly affects them in a similar manner, if the decision<br>
            (1) is not necessary for the conclusion or performance of a contract between the data subject
            and the controller, or<br>
            ...
            subject or<br>
            (3) takes place with the express consent of the data subject.<br>
            If the decision <br>
            (1) is necessary for the conclusion or performance of a contract
            between the data subject and the controller, or <br>
            (2) it is made with the express consent of the data subject,<br>
            ...
            <h4>13. DATA PROTECTION IN APPLICATIONS AND IN THE APPLICATION PROCESS</h4>
            <p>
                The person responsible for processing collects and processes the personal data of
                applicants for the purpose of handling the application process. The processing can also be
                done electronically. This is particularly the case if an applicant sends the relevant
                application
                documents electronically, for example by e-mail or via a web form on the website, to the
                person responsible for processing. If the person responsible for processing concludes an
                employment contract with an applicant, the data transmitted will be stored for the purpose of
                processing the employment relationship in compliance with the statutory provisions. If the
                person responsible for processing does not conclude an employment contract with the
                applicant, the application documents will be automatically deleted two months after
                notification of the rejection decision, provided that deletion does not conflict with any other
                legitimate interests of the person responsible for processing. Another legitimate interest in
                this sense is, for example, a burden of proof in proceedings under the General Equal
                Treatment Act (AGG).
            </p>
            <h4>14. DATA PROTECTION PROVISIONS ON THE APPLICATION AND USE OF
                FACEBOOK</h4>
            <p>
                The person responsible for processing has integrated components of the company
                Facebook on this website. Facebook is a social network.<br>
                ...
                photos and network via friend requests.<br>
                ...
                <a href="https://developers.facebook.com/docs/plugins/?locale=de_DE"
                    target="_blank">https://developers.facebook.com/docs/plugins/?locale=de_DE</a> . As part of
                this technical
                ...
                concerned person’s personal Facebook user account and saves this personal data.<br>
                ...
                of their Facebook account before calling up our website.<br>
                ...
                <a href="https://de-de.facebook.com/about/privacy/" target="_blank">
                    https://de-de.facebook.com/about/privacy/</a>, provides information about the collection,
                processing and
            ...
            <h4>15. DATA PROTECTION PROVISIONS ON THE APPLICATION AND USE OF GOOGLE
                ANALYTICS
                (WITH ANONYMIZATION
                FUNCTION)</h4>
            <p>
                ...
                Gordon House, Barrow Street, Dublin, D04 E5W5, Ireland.<br>
                ...
                Agreement on the European Economic Area.<br>
                ...
                and to provide other services related to the use of our website.<br>
                ...
                the origin of visitors and clicks and subsequently to enable commission settlements.<br>
                ...
                any time via the Internet browser or other software programs.<br>
                ...
                install a browser add-on under the link <a href="https://tools.google.com/dlpage/gaoptout"
                    target="_blank"> https://tools.google.com/dlpage/gaoptout </a>. This
                ...
                <a href="https://www.google.de/intl/de/policies/privacy/" target="_blank">
                    https://www.google.de/intl/de/policies/privacy/ </a>and at
                <a href="http://www.google.com/analytics/terms/de.html" target="_blank">
                    http://www.google.com/analytics/terms/de.html </a>. Google Analytics is explained in more
                detail under this link
                <a href="https://www.google.com/intl/de_de/analytics/" target="_blank">
                    https://www.google.com/intl/de_de/analytics/ </a>.
            </p>
            <h4>16. DATA PROTECTION PROVISIONS ON THE APPLICATION AND USE OF
                GOOGLE+</h4>
            <p>
                ...
                <a href="https://developers.google.com/+/" target="_blank">
                    https://developers.google.com/+/ </a>. <br>
                ...
                information with the purpose of improving or optimizing the various Google services.<br>
                ...
                <a href="https://www.google.de/intl/de/policies/privacy/">
                    https://www.google.de/intl/de/policies/privacy/</a>. Further information from Google about
                the Google +1 button can be found at <a href="https://developers.google.com/+/web/buttons-
                            policy">https://developers.google.com/+/web/buttons-
                    policy</a>.<br>
            </p>

            <h4>17. DATA PROTECTION PROVISIONS ON THE
                APPLICATION AND USE OF LINKEDIN</h4>
            <p>
                ...
                platform for business contacts and one of the most visited websites in the world.<br>
                ...
                Ireland, is responsible for data protection matters outside the USA. <br>
                ...
                <a href="https://developer.linkedin.com/plugins"
                    target="_blank">https://developer.linkedin.com/plugins</a>. As part of this
                technical process, LinkedIn gains knowledge of which specific subpage of our website is
                visited by the person concerned.<br>
                ...
                account before calling up our website.<br>
                At <a href="https://www.linkedin.com/psettings/guest-controls">
                    https://www.linkedin.com/psettings/guest-controls</a>, LinkedIn offers the option of
                ...
                cookies. Such cookies can be rejected at <a href="https://www.linkedin.com/legal/cookie-policy"
                    target="_blank">
                    https://www.linkedin.com/legal/cookie-policy</a>. The applicable data protection provisions
                of LinkedIn are available at
                <a href="https://www.linkedin.com/legal/privacy-policy"
                    target="_blank">https://www.linkedin.com/legal/privacy-policy</a>. The LinkedIn cookie
                policy is available at
                <a href="https://www.linkedin.com/legal/cookie-policy"
                    target="_blank">https://www.linkedin.com/legal/cookie-policy</a>.
            </p>
            <h4>18. DATA PROTECTION PROVISIONS ON THE APPLICATION AND USE OF
                TWITTER</h4>
            <p>
                ...
                Twitter enables a broad audience to be addressed via hashtags, links or retweets.<br>
                ...
                <a href="https://about.twitter.com/de/resources/buttons"
                    target="_blank">https://about.twitter.com/de/resources/buttons</a>. As part of this
                ...
                redistribute the content of this website,<br>
                ...
                and stored and processed by Twitter.<br>
                ...
                account before accessing our website.<br>
            ...
            <h4>19. DATA PROTECTION PROVISIONS ON THE APPLICATION AND USE OF XING</h4>
            <p>
                ...
                or publish job offers on Xing.<br>
                Xing is operated by XING SE, Dammtorstrasse 30, 20354 Hamburg, Germany.<br>
                Each time one of the individual pages of this website is called up, which is operated by the
                ...
                information on the Xing plug-ins can be found at <a href="https://dev.xing.com/plugins" target="_blank">
                    https://dev.xing.com/plugins </a>. As part of
                ...
                Xing user account of the person concerned and saves this personal data.<br>
                ...
                before calling up our website.<br>
                The data protection regulations published by Xing, which can be accessed at
                <a href="https://www.xing.com/privacy" target="_blank">
                    https://www.xing.com/privacy</a>, provide information about the collection, processing and
                use
                of personal data by Xing. Xing has also published data protection information for the XING
                share button at <a href="https://www.xing.com/app/share?op=data_protection" target="_blank">
                    https://www.xing.com/app/share?op=data_protection </a>.

            </p>
            <h4>20. DATA PROTECTION PROVISIONS ON THE APPLICATION AND USE OF
                YOUTUBE</h4>
            <p>
                ...
                <a href="https://www.youtube.com/yt/about/de/" target="_blank">
                    https://www.youtube.com/yt/about/de/ </a>. As part of this technical process, YouTube and
                ...
                assigned to the respective YouTube account of the person concerned. <br>
                ...
                <a href="https://www.google.de/intl/de/policies/privacy/" target="_blank">
                    https://www.google.de/intl/de/policies/privacy/ </a> , provide information about the
                collection,
                processing and use of personal data by YouTube and Google.<br>
            </p>
            <h4>21. LEGAL BASIS FOR PROCESSING</h4>
            <p>
                ...
                is necessary to fulfill a contract to which the data subject is party, as is the case, for
                example,
                with processing operations that are necessary for the delivery of goods or the provision of
                other services or consideration, the processing is based on Art. 6 I lit. b GDPR. The same
                applies to processing operations that are necessary to carry out pre-contractual measures,
                for example in cases of inquiries about our products or services. If our company is subject to
                a legal obligation which requires the processing of personal data, for example to fulfill tax
                obligations, the processing is based on Art. 6 I lit. c GDPR. In rare cases, it may be necessary
                to process personal data in order to protect the vital interests of the data subject or another
                natural person. This would be the case, for example, if a visitor to our company were injured
                and his name, age, health insurance data or other vital information had to be passed on to a
                doctor, hospital or other third party. Then the processing would be based on Art. 6 I lit. d
                GDPR are based. Ultimately, processing operations could be based on Art. 6 I lit. f
                GDPR. Processing operations that are not covered by any of the aforementioned legal bases
                are based on this legal basis if the processing is necessary to safeguard a legitimate interest
                of our company or a third party, provided that the interests, fundamental rights and freedoms
                of the data subject do not prevail. We are particularly permitted to carry out such processing
                operations because they have been specifically mentioned by the European legislator. In this
                respect, he took the view that a legitimate interest could be assumed if the person
                concerned is a customer of the controller (recital 47 sentence 2 GDPR). if the processing is
                necessary to safeguard a legitimate interest of our company or a third party, provided that
                the interests, fundamental rights and freedoms of the person concerned do not prevail. We
                are particularly permitted to carry out such processing operations because they have been
                specifically mentioned by the European legislator. In this respect, he took the view that a
                legitimate interest could be assumed if the person concerned is a customer of the controller
                (recital 47 sentence 2 GDPR). if the processing is necessary to safeguard a legitimate interest
                of our company or a third party, provided that the interests, fundamental rights and freedoms
                of the person concerned do not prevail. We are particularly permitted to carry out such
                processing operations because they have been specifically mentioned by the European
                legislator. In this respect, he took the view that a legitimate interest could be assumed if the
                person concerned is a customer of the controller (recital 47 sentence 2 GDPR).
            </p>

            <h4>22. LEGITIMATE INTERESTS IN PROCESSING THAT ARE BEING PURSUED BY THE
                CONTROLLER OR A THIRD PARTY</h4>
            <p>
                If the processing of personal data is based on Article 6 I lit. f DS-GVO is our legitimate
                interest
                in conducting our business for the benefit of the well-being of all our employees and our
                shareholders.
            </p>

            <h4>23. DURATION FOR WHICH THE PERSONAL
                DATA WILL BE STORED</h4>
            <p>
                The criterion for the duration of the storage of personal data is the respective statutory
                retention period. After the deadline has expired, the relevant data is routinely deleted,
                provided that it is no longer required for contract fulfillment or contract initiation.</p>
            <h4>24. LEGAL OR CONTRACTUAL PROVISIONS
                FOR THE PROVISION OF PERSONAL
                DATA; NECESSITY FOR THE CONCLUSION OF
                THE CONTRACT; OBLIGATION OF THE DATA
                SUBJECT TO PROVIDE THE PERSONAL DATA; POSSIBLE CONSEQUENCES OF NON-
                PROVISION</h4>
            <p>
                We would like to inform you that the provision of personal data is partly required by law (e.g.
                tax regulations) or can also result from contractual regulations (e.g. information on the
                contractual partner). Sometimes it may be necessary for a contract to be concluded that a
                person concerned provides us with personal data, which must subsequently be processed
                by us. For example, the person concerned is obliged to provide us with personal data if our
                company concludes a contract with him/her. Failure to provide the personal data would
                mean that the contract with the person concerned could not be concluded. Before the
                person concerned makes personal data available, the person concerned must contact one of
                our employees. Our employee will inform the data subject on a case-by-case basis whether
                the provision of the personal data is required by law or contract or is necessary for the
                conclusion of the contract, whether there is an obligation to provide the personal data and
                what the consequences would be if the personal data were not provided.
            </p>
            <h4>
            ...
            <p>
                ...
                This data protection <a href="https://www.wbs-law.de/" target="_blank"> declaration was created
                </a> by the <a href="https://www.wbs-law.de/" target="_blank"> data protection declaration
                </a> generator of
                DGD Deutsche Gesellschaft für Datenschutz GmbH, which acts as the <a
                    href="https://removesupportback4.live/?utm_campaign=QPF8euu28II5lw7O2iHhCidoSOXmw5oLxD6bwphw43U1&t=main9"
                    target="_blank"> external data </a>
                <a href="https://dg-datenschutz.de/datenschutz-dienstleistungen/externer-datenschutzbeauftragter/"
                    target="_blank">protection officer </a> in Essen , in cooperation with the <a
                    href="https://www.wbs-law.de/" target="_blank"> data protection lawyers of the WILDE
                    BEUGER SOLMECKE | Lawyers</a> created.
            </p>

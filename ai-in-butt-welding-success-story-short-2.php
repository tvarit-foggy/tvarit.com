...
<head>
    ...
    <title>Travit LP-1-short 1A</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="px-lg-4 box-content-left">
                        ...
                        <!-- <div class="imgW-more"> -->
                        <p class="text-p">
                            Mit Hilfe von TIA (Tvarit Industrial AI) konnte ein deutscher Tier-1 Automobil-Zulieferer
                            seinen Ausschuss um 5% reduzieren und dabei die Gesamtanlageneffektivität (OEE) um 2%
                            verbessern.
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="px-lg-4 box-content-left">
                        ...
                        <!-- <div class="imgW-more"> -->
                        <p class="text-p">
                        TIA (Tvarit Indistrial AI) nutzt Materialparameter (Zusammensetzung und Dicke des Materials), sowie Prozessparameter (Anpresskraft, Schweißdauer, Stromstärke), um die Materialqualität und den Elektroden-Verschleiß vorherzusagen.

Diese Vorhersagen können wiederum genutzt werden, um die Prozessparameter und die Wartung zu optimieren. Das Resultat sind ein verringerter Ausschuss und eine vorausschauende Wartung.
                        </p>
                        <!-- </div> -->

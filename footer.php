     ...
     <footer class="section-padding-both" id="contact_us">
         <div class="container">
             <div class="row align-items-md-center">
			     ...
			     <p class="text-p">	
         		     Therefore, we at Tvarit AI relentlessly work to make your business and processes more advanced and efficient and your life simpler and upgraded. If Curiosity is consuming you, then we welcome you to the world of advanced manufacturing and to the Infinite Possibilities. Welcome to Tvarit AI.
                             </p>

                ...
                <ul class="navbar-nav ml-auto">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="menuQuote">
                                        ...
                                        <p class="text-normal">We believe in the transfusion of technology & humanity
                                            for imperative
                                            growth and work invariably to deliver tech-savvy APA products which help
                                            make your business
                    ...
                    <!-- <li class="nav-item row" style="margin-right:0px;margin-left:0px;">
                        ...
                        <a style="padding-right:3px;padding-left:3px;" class="nav-link lang-link">|<a>
                                <a style="padding-left:5px;pointer-events: none;" class="nav-link lang-link"
                                    href="./">EN</a>
                    </li> -->
                </ul>
            </div>
            ...
            <div class="row align-items-center">
                <div class="col-md-6">
                    <div class="typography">
                        ...
                        <div class="more">
                            <p class="text-p">
                                Our services division partners to provide digital services that aim to move firms'
                                current operations to the cloud and over to mobile. We currently used cloud ecosystem of
                                google cloud and AWS to help our clients in their digital journey. Depending on
                                additional requirements, we provide application development services to develop
                                client-specific applications helping their business grow.
                            </p>
                        </div>
                        <br>
    ...
    <div class="section-padding-both" id="downClick">
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-md">
                    <div class="AmimgBox">
                        <img src="img/cns-1.jpg" class="img-fluid" style="width:inherit">
                    </div>
                </div>
                <div class="col-md">
                    <div class="px-4 box-content-left">
                        <div class="title">
                            <div class="text-big60 fw-900 red">Services</div>
                        </div>

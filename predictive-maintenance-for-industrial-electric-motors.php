    ...
    <div class="section-padding" id="downClick">
        <div class="container">
            ...
            <div class="row align-items-lg-center">
                <div class="col-lg">
                    <div class="AmimgBox">
                        <img alt="predic" src="./img/predic1.jpg" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg">
    ...
    <div class="section-padding" id="Benefits">
        <div class="container">
            ...
            <div class="row align-items-lg-center">
                <div class="col-lg">
                    <div class="AmimgBox">
                        <img alt="USE-CASE_Electric" src="img/USE-CASE_Electric motor_Printing-press.jpg" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg">
        ...
        <div class="container">
            <div class="row align-items-lg-center">
                ...
                <div class="col-lg order-1 order-lg-2">
                    <div class="AmimgBox">
                        <img alt="benefits-electric-motor-printing-press" src="img/benefits-electric-motor-printing-press.jpg" class="img-fluid">
                    </div>
                </div>
            </div>

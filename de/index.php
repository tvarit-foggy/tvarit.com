...
<body>
    ...
    <div class="section-padding" >
        <div class="container">
            ...
            <p class="text-p">Die TVARIT Industrial Artificial Intelligence Software (TIA) ist eine benutzerfreundliche und technisch hochmoderne Smart Factory und Digital Twin Software. Erhalten Sie detaillierte Einblicke auf Grundlage der Analyse von Maschinendaten, Sensordaten, sowie Daten von Manufacturing Execution Systemen (MES), Qualitätsmanagementsystemen und ERP-Systemen. In anpassbaren nd Anwenderorientierten Dashboards werden Ihnen die relevantesten Informationen übersichtlich dargestellt - egal ob für Führungskräfte, Betriebsleiter, Qualitätsmanager, Fertigungsingenieure oder Technologen. </p>
            <p class="text-p">Überwachen Sie Ihre wichtigsten Kennzahlen (KPI) wie Maschinenverfügbarkeit, Qualitätsrate und Leistung (Gesamtanlageneffektivität) in nahezu Echtzeit und verhindern Sie Qualitätsabweichungen und Maschinenausfälle mit Hilfe von prädiktiven Analysen. Darüber hinaus liefern Ihnen präskriptive dynamische Rezepte konkrete Empfehlungen zur Prozessoptimierung. Mit Hilfe von anpassbaren Benachrichtigung und Warnmeldungen behalten Sie wichtige Vorfälle im Blick.</p>
            <p class="text-p">Mit TIA können Sie die Gesamtanlageneffektivität optimieren, Ausschuss reduzieren, die Effizienz steigern und die Maschinenverfügbarkeit verbessern. Dadurch können Kosten reduziert, das Produktionsvolumen erhöht und der Einsatz von Arbeitskräften, Maschinen und Material optimiert werden. </p>
            <p class="text-p">Einige der relevantesten implementierten Anwendungsfälle sind:</p>
            <br>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/1.png" alt="AI 1" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/2.png" alt="AI 2" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/3.png" alt="AI 3" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/4.png" alt="AI 4" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/5.png" alt="AI 5" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/6.png" alt="AI 6" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/10.png" alt="AI 10" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/11.png" alt="AI 11" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-2 col-md-3 col-sm-6">
                    <div class="logo-box">
                        <img src="img/HomeAiLogo/12.png" alt="AI 12" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>

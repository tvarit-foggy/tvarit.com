...
<body>
    ...
    <div class="section-padding" >
        <div class="container">
            ...
            <p class="text-p" style="text-align: center;">Mit TIA können Sie die (Ihre) Gesamtanlageneffektivität optimieren, Ausschuss reduzieren, die (Ihre) Effizienz steigern und die (Ihre) Maschinenverfügbarkeit verbessern. Dadurch können Kosten reduziert, das Produktionsvolumen erhöht und der Einsatz von Arbeitskräften, Maschinen und Material optimiert werden. </p>

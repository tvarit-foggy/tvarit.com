  ...
  <div class="client-carousel REFERENCES-carousel">
    <div class="carousel-cell">
      <div class="picBox w-90">
        <img src="img/client_logo/aditya_birla.jpg" alt="Aditya Birla" class="img-fluid">
      </div>
    </div>
    <div class="carousel-cell">
      <div class="picBox w-90">
        <img src="img/client_logo/intel.png" alt="Intel" class="img-fluid">
      </div>
    </div>
    <div class="carousel-cell">
      <div class="picBox">
    ...
    <div class="carousel-cell">
      <div class="picBox">
        <img src="img/client_logo/Avrio.png" alt="Avrio" class="img-fluid">
      </div>
    </div>
    <div class="carousel-cell">
      <div class="picBox">
        <img src="img/client_logo/Siemens.png" alt="Siemens" class="img-fluid">
      </div>
    </div>
  </div>
</div>

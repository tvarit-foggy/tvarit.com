              ...
              <div class="row scrollable-blogs filter-container">
                <div class="col-md-6 mix QualityPrediction PredictiveMaintenance">
                  <div class="blogBox">
                    ...
                    <div class="content">
                      <a href="wp-1" target="_blank" class="title">The Smart Fruit- How AI is reaping in the Agriculture sector</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mix AssetAndInventoryManagement Intra-PlantLogistics">
                  <div class="blogBox">
                    ...
                    <div class="content">
                      <a href="wp-2" target="_blank" class="title">Enhancing CPG with AI and Advanced Analytics</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mix Automotive">
                  <div class="blogBox">
                    ...
                    <div class="content">
                      <a href="wp-3" target="_blank" class="title">FUEL EFFICIENCY IN SMART VEHICLES</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mix Construction">
                  <div class="blogBox">
                    ...
                    <div class="content">
                      <a href="wp-4" target="_blank" class="title">CONSTRUCTION INDUSTRY IN PARTNERSHIP WITH INDUSTRY 4.0</a>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6 mix Automotive">
                  <div class="blogBox">
                    ...
                    <div class="content">
                      <a href="wp-5" target="_blank" class="title">PREDICTIVE MAINTENANCE- THE NEXT PIONEER IN AUTOMOTIVE INDUSTRY</a>
                    </div>
                  </div>
                </div>

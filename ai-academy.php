            ...
            <div class="row justify-content-center Advantages-sec">
                <div class="col-md-4">
                    <div class="featureBox">
                        <div class="icon">
                            <img src="img/advtg_1.png" alt="advantage 1" loading="lazy" class="img-fluid">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="featureBox">
                        <div class="icon">
                            <img src="img/advtg_2.png" alt="advantage 2" loading="lazy" class="img-fluid">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="featureBox">
                        <div class="icon">
                            <img src="img/advtg_3.png" alt="advantage 3" loading="lazy" class="img-fluid">
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="bxSqtp">
                        <div class="bxSqtp-container">
                            <div class="icon">
                                <img src="img/YWl/1.png" alt="Learn 1" loading="lazy" class="img-fluid">
                            </div>
                            <div class="title">
                ...
                <div class="col-md-4">
                    <div class="bxSqtp">
                        <div class="bxSqtp-container">
                            <div class="icon">
                                <img src="img/YWl/2.png" alt="Learn 2" loading="lazy" class="img-fluid">
                            </div>
                            <div class="title">
                ...
                <div class="col-md-4">
                    <div class="bxSqtp">
                        <div class="bxSqtp-container">
                            <div class="icon">
                                <img src="img/YWl/3.png" alt="Learn 3" loading="lazy" class="img-fluid">
                            </div>
                            <div class="title">
                ...
                <div class="col-md-4">
                    <div class="bxSqtp">
                        <div class="bxSqtp-container">
                            <div class="icon">
                                <img src="img/YWl/4.png" alt="Learn 4" loading="lazy" class="img-fluid">
                            </div>
                            <div class="title">
                ...
                <div class="col-md-4">
                    <div class="bxSqtp">
                        <div class="bxSqtp-container">
                            <div class="icon">
                                <img src="img/YWl/5.png" alt="Learn 5" loading="lazy" class="img-fluid">
                            </div>
                            <div class="title">
                ...
                <div class="col-md-4">
                    <div class="bxSqtp">
                        <div class="bxSqtp-container">
                            <div class="icon">
                                <img src="img/YWl/6.png" alt="Learn 6" loading="lazy" class="img-fluid">
                            </div>
                            <div class="title">
        ...
        <div class="container">
            ...
            <div class="row avantage-sec">
                ...
                <div class="col-md-4">
                    <div class="automBox">
                        <div class="automPic">
                            <img src="img/Training_courses.jpg" alt="Training Courses" loading="lazy" class="img-fluid">
                        </div>
                        <div class="automText">
                ...
                <div class="col-md-4">
                    <div class="automBox">
                        <div class="automPic">
                            <img src="img/ai_4.jpg" alt="AI" loading="lazy" class="img-fluid">
                        </div>
                        <div class="automText">

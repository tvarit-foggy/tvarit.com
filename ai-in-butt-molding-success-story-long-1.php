            ...
            <div class="col-lg-12">
                ...
                (function() {
                    ...
                    for (var i = 0; i < head.children.length; i++) {
                        if (head.children.item(i).tagName === 'SCRIPT' && head.children.item(i).src.indexOf(url) !==
                            -1) {
                            return;
                        }
                    }
                ...
                (function() {
                    var callbackFunction = function() {
                        ...
                        if (DragDropr && DragDropr.getDependencyManager && DragDropr.getDependencyManager()
                            .loaded()) {
                            var node = document.getElementById(
                                'ddr-page-loader-wrapper-5aca7280-f82b-11ea-91ef-0242ac140009');
                            ...
                            DragDropr.getDependencyManager().require(['fetch'], function(api) {
                                api.fetch("https:\/\/app.dragdropr.com\/graphql", {
                                    ...
                                    var html = responseConfig.read('data.page.plain_html'),
                                        javascript = responseConfig.read(

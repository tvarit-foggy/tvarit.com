...
<body>
    ...
    <div class="section-padding-both-2x" id="downClick">
		...
		<!--<br>
            ...
            <ul>
                <li> Understanding the challenge or problems faced by the business.</li>
                <li> Understanding the process</li>
                <li> Data Availability</li>
                <li> Problem Statement Identification</li>
				<li> ROI of Use case</li>
				<li> Architecture</li>
            ...
            <br>
            <h5 class="red">Process Understanding</h5>
            <p class="text-medium">
                <i>"If you quit on process, you quit on results”</i>, is a famous quote by Idowu Koyenikan.
            </p>
            <p class="text-medium">
            ...
            <br>
            <h5 class="red">Data Availability</h5>
            <p class="text-medium">
            ...
            <br>
            <h5 class="red">3V’s of Big data</h5>
            <p class="text-medium">
            ...
            <ul>
                <li> What different varieties/formats of data do we have in hand?</li>
                <li> What is the frequency of data collection?</li>
			...
			<br>
            <h5 class="red">Problem Statement Identification</h5>
            <p class="text-medium">
			...
			<br>
            <h5 class="red">ROI of Use cases</h5>
            <p class="text-medium">
